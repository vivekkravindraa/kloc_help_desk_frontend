...
export default class ModeratorTickets extends Component {
    ...
    getAll = () => {
        axios.get(`${baseURL}/tickets/tickets_raised`,{headers: {'x-auth': localStorage.getItem('x-auth')}})
        .then((response) => {
            this.setState({
    ...
    handleFilterByStatus = (e) => {
        ...
        axios.get(`${baseURL}/tickets/filter_by_status?ticketStatus=${value}&filterTickets=myTickets`,{headers: {'x-auth': localStorage.getItem('x-auth')}})
        .then((response) => {
            this.setState({
                ticketsData: response.data,
                filterData: response.data
    ...
    handleFilterByPriority = (e) => {
        let value = e.target.value;
        axios.get(`${baseURL}/tickets/filter_by_priority?ticketPriority=${value}&filterTickets=myTickets`,{headers: {'x-auth': localStorage.getItem('x-auth')}})
        .then((response) => {
            this.setState({
                ticketsData: response.data,
                filterData: response.data
    ...
    handleAssign = (id) => {
        axios.get(`${baseURL}/tickets/${id}/assign`,{headers: {'x-auth': localStorage.getItem('x-auth')}})
        .then((response) => {
            this.setState({
                isAssignedToMe: true
            })
    ...
    render() {
        ...
        return (
            <div className="container">
                <Navigation />
                <form>
                    <h2 style={{textAlign:"center"}}>Unassigned tickets</h2>
